// QualifGaïndé Worldwide — Service Worker V11.3.4
const CACHE_VERSION = 'qg-v11-3-4-static';
const RUNTIME_CACHE = 'qg-v11-3-4-runtime';
const CORE_ASSETS = [
  '/',
  '/index.html',
  ...
  '/src/v10/v10-team-app.css?v=11.3.4',
  '/src/v10/v10-team-app.js?v=11.3.4'
];
