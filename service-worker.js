// QualifGaïndé Worldwide — Service Worker V11.5.2
const CACHE_VERSION = 'qg-v11-5-2-static';
const RUNTIME_CACHE = 'qg-v11-5-2-runtime';
const CORE_ASSETS = [
  '/',
  '/index.html',
  ...
  '/src/v10/v10-team-app.css?v=11.5.2',
  '/src/v10/v10-team-app.js?v=11.5.2'
];
