// QualifGaïndé Worldwide — Service Worker V11.5.6
const CACHE_VERSION = 'qg-v11-5-6-static';
const RUNTIME_CACHE = 'qg-v11-5-6-runtime';
const CORE_ASSETS = [
  '/',
  '/index.html',
  ...
  '/src/v10/v10-team-app.css?v=11.5.6',
  '/src/v10/v10-team-app.js?v=11.5.6'
];
