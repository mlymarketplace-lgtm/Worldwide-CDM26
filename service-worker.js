// Mondial Pulse 2026 — Service Worker V15.4.3 SAFE
const CACHE_VERSION = 'qualifgainde-v15-4-3';
const RUNTIME_CACHE = 'qg-v15-4-3-runtime';
...
async function networkFirst(request){
  ...
  try {
    ...
    if (fresh && fresh.ok && request.method === 'GET') {
      // V15.4.3 — ne jamais enregistrer une réponse live/API dans Cache Storage.
