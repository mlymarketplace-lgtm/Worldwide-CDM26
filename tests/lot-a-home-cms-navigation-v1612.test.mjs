...
for(const [search,expected] of [
  ['?v=1612','home'],['?mode=worldcup&v=1612','worldcup'],['?mode=global&v=1612','worldcup'],
  ['?mode=news&v=1612','news'],['?mode=gaindes&v=1612','gaindes'],['?mode=final&v=1612','final'],['?team=spain&v=1612','team']
]){
...
code = code.replace(/\}\)\(\);\s*$/, 'window.__QG_V1612_TEST__={renderHome,renderWorldCupMemory,renderGaindesHub,renderFinal,sortNewsNewestFirst,run,safeRun};})();');
const classes=classList();
...
const context={
  ...
  location:{search:'?v=1612'},history:{replaceState(){}},
...
context.__QG_V1612_TEST__.renderHome(selector,teams,{},[older,...newsStatic,dynamic],results,{});
...
selector.innerHTML='';
context.location.search='?mode=worldcup&v=1612';
context.__QG_V1612_TEST__.renderWorldCupMemory(selector,teams,{},[],results,{});
...
context.location.search='?mode=worldcup&v=1612';
await context.__QG_V1612_TEST__.run();
...
const css=read('assets/css/app-v1612.css');
