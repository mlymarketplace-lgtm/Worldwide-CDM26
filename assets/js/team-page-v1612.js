(function(){
  ...
  async function renderTeamPage(){
    ...
    try {
      ...
      window.dispatchEvent(new CustomEvent('qg:v1612TeamRendered',{detail:{teamId,lang}}));
    } catch (error) {
      console.error('[Suivi des Lions V16.1.2 team renderer]', error);
  ...
  window.renderTeamPageV1612 = renderTeamPage;
